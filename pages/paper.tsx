    ...
    <>
      ...
      >
        ...
        <Block title="So, what is Winzeland?">
          <p>
            Winzeland is browser game which combines roleplaying, idle game
            styles and blockchain to create unique NFT powered game world on
            Polygon network. Characters, lands and all of Winzeland resources
            are NFTs that players will be able to gather and trade between
            friends.
          </p>
        </Block>
        ...
        <Block title="Where NFTs come in?">
          ...
          <p>
            Winzers are characters and citizens of Winzeland world. They are
            most important NFTs for the players because Winzers will be doing
            bidding of their owner:
          </p>
          <ul className="ul">
          ...
          <p>
            ...
            which building they are assigned and what kind of equipment they
            have.
          </p>
          <p>
            It's planned to offer 100 000 winzers initially, however players
            will have a possibility to "marry" any two owned ones and receive
            third one.
          </p>
          <p>
            ...
            which enchanches winzers capabilies or curse which decreases them,
            for example blessing could increase winzers crafting speed by 15%,
            while curse would curse would decrease it.
          </p>
          ...
          <p>
            Resources will contain everything else that player can own and is
            not Winzer and Land in the Winzeland World:
          </p>
          <ul className="ul">
          ...
          <ul className="ul">
            <li>
              Put <em>wood</em> on fire to create <em>bonfire</em>, after fire
              is put down you will receive some <em>charcoal</em>
            </li>
            <li>
        ...
        <Block title="Trading in Winzeland and Gubbins">
          ...
          <p>
            Trade would happen by one player submitting sell order of how much
            of one resource they want to change to another resource.
          </p>
          <blockquote>
          ...
          <p>
            Of course trading one resource to another over and over until you
            get what you actually want may take some time, that's why we are
            introducing <strong>Gubbins</strong> - currency, which will be used
            in the Winzeland.
          </p>
          <blockquote>
        ...
        <Block title="Building Settlement">
          ...
          <p>
            ...
            There could be different types of constructions: defensive
            buildings, workshops or infrastructure.
          </p>
          <h3 className="mt-5 mb-3">Defensive Buildings</h3>
          <p>
            As name suggests defensive buildings would increase settlement
            defence making it harder for enemies to attack it.
          </p>
          <h3 className="mt-5 mb-3">Workshops</h3>
          <p>
            Workshops would be buildings where players would assign (stake)
            their winzers, add one kind of resource and workshop would make
            another kind of a resource back after some time: Put 2{' '}
            <em>wood logs</em> to the <em>sawmill</em> and receive 1{' '}
            <em>wood plan</em> after 30 minutes.
          </p>
          <h3 className="mt-5 mb-3">Infrastructure Buildings</h3>
          <p>
            Settlement infrastructure would add some bonuses for settlements.
            For example we could have winzer (lets call him Picker) assigned to
            move resources from one workshop to another so player would not be
            required to add resources to the workshop manually.
          </p>
          <p>
            For example, if player has two buildings <em>Woodcutter's Hut</em>{' '}
            which allows Winzer to chopdown forest for the <em>wood logs</em>{' '}
            and a <em>Sawmill</em> which would allow Winzer to make{' '}
            <em>wood planks</em> out of the <em>wood logs</em>.
          </p>
          <p>
            Without a <em>Picker</em>, player would have to take{' '}
            <em>wood logs</em> from <em>Woodcutter's Hut</em> and place it to
            the <em>Sawmill</em> so it would make <em>wood planks</em> manually.
            But <em>Picker</em> could do this for the player, automating
            process.
          </p>
        </Block>
        <Block title="Governance with DAO">
          ...
          <ul className="ul">
            ...
            <li>
              Registering new game resources: weapons, buildins, potions and
              etc;
            </li>
